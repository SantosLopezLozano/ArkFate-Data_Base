        ...
        <table id="tablita" class="table table-dark table-striped">
            ...
            <%
                while (listado.next()) {
                    ...
                    out.print("<tr>");
                    out.print("<td>");
                    out.println(listado.getString("CodObj"));
                    out.print("</td>");
                    
                    out.print("<td>");
                    out.println(listado.getString("NomObj"));
                    out.print("</td>");
                    
                    out.print("<td>");
                    out.print("<a href='borraobjeto.jsp?CodObj=");
                    out.print(listado.getString("CodObj"));
                    out.print("' <i class='bi bi-trash'></i></a>");
                    out.print("</td>");
                    
                    out.print("<td>");
                    out.print("<a href='formularioObjeto.html?CodObj=");
                    out.print(listado.getString("CodObj"));
